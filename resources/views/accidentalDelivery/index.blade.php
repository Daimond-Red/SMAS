...
<div id="kt_quick_panel" class="kt-quick-panel">
    ...
    <div class="kt-quick-panel__content">
        <div class="container px-4">
            {!! Form::open([ 'data-content' => '#searchFormContent', 'id' => 'search-form', 'route' => ['accidental-delivery'] ]) !!}
            {{-- <form class="pt-4" method="POST" action="{{ route('service-delivery-filter') }}"> --}}
                ...
                <a href="{{ route('accidental-delivery') }}" class="btn btn-danger sidebarSearchClear" data-content="#searchFormContent">Clear</a>
            </form>
        </div>
    </div>
</div>
