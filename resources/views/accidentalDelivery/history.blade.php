...
<div id="kt_quick_panel" class="kt-quick-panel">
    ...
    <div class="kt-quick-panel__content">
        <div class="container px-4">
            {!! Form::open([ 'data-content' => '#searchFormContent', 'id' => 'search-form', 'route' => ['accidental-history'] ]) !!}
            {{-- <form class="pt-4" method="POST" action="{{ route('service-delivery-filter') }}"> --}}
                ...
                <a href="{{ route('accidental-history') }}" class="btn btn-danger sidebarSearchClear" data-content="#searchFormContent">Clear</a>
            </form>
        </div>
    </div>
</div>
                                ...
                                <table class="data-table-export table table-bordered table-sm">
                                   ...
                                   <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{ route('accidental-history-show', $model->BookingNumber )}}" class="badge badge-info">View Details</a></td>
                                        </tr>    
                                        @endforeach
                                   </tbody>
                                </table>
...
@section('script')
    <script>
        $(document).ready(function(){
            $('.accidental-history-menu').addClass('kt-menu__item--active');
        });
    </script>
@stop
